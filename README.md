...
The page will call OpenAI to rewrite your summary toward the role, reorder the most relevant experiences to the top, and lightly adjust phrasing to match the posting. You can copy the generated sections to update your resume.
